...
public class CookieDataCodecTest {
    ...
    public void constructorOutputVoid() {
      ...
      CookieDataCodec objectUnderTest = new CookieDataCodec();
     ...
     *  - conditional line 77 branch to line 78
     */

    @Test
    public void safeEqualsInputNotNullNotNullOutputFalse() {

      // Arrange
      final String a = "";
      final String b = "BCCCCCCC";

      // Act
      final boolean retval = CookieDataCodec.safeEquals(a, b);
